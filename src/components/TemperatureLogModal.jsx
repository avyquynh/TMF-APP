...
export function TemperatureLogModal({
  ...
  onClose: () => void;
  onSubmit: (plantId, temperature) => void;
}) {
            ...
            <div className="bg-[#f5f0eb] rounded-3xl p-6">
              ...
              <div className="mb-4">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[#3d5a4a]">Expected°C</span>
                </div>
                ...
                <div className="relative h-32 flex items-center justify-center mb-4">
                  <div className="relative w-full max-w-xs">
                    ...
                    <div 
                      className="absolute top-1/2 -translate-y-1/2 w-3 h-3 bg-[#8b6f47] rounded-full border-4 border-white shadow-lg"
                      style={{ left: `${(currentTemp / 40) * 100}%` }}
                    />
                  </div>
                </div>
